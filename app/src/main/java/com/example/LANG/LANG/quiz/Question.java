...
public class Question implements Parcelable {
    ...
    public Question(String soru, String option1, String option2, String option3,
                    int cvp, String zorluk, int categoryID) {
        this.soru = soru;
