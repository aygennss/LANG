...
public class KelimeCumle extends AppCompatActivity implements TextToSpeech.OnInitListener {
    ...
    int i=0;
    int index=0;
    String basic_beg = "Nasıl Söylenrir\n \"";
    String basic_end ;
    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      //   ttobj.setLanguage(Locale.FRENCH);
        ...
        String total= KelimeConstants.Translations.CUMLE.phrases[0]+basic_end+basic_beg;
        editText1.setText(total, TextView.BufferType.EDITABLE);
        imageView1.setImageResource(KelimeConstants.Basic_pics.basic_pics[4]);
    ...
    public void next(View v){
        ...
        try {
            if(i==9)
                ...
                Intent i = new Intent(KelimeCumle.this, Kelimebolum.class);
                startActivity(i);
            }
            String total = basic_beg + KelimeConstants.Translations.CUMLE.phrases[i] + basic_end;
            Log.i("TAG", total);
            editText1.setText(total, TextView.BufferType.EDITABLE);
            imageView1.setImageResource(KelimeConstants.Basic_pics.basic_pics[4]);
            ...
            public void run() {
                handler.post(new Runnable() {
                    public void run() {
                        ...
                        editText2.setText(KelimeConstants.Template.PHRASES.phrases[index][i]);
